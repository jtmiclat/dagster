...
# FIXME tag with the context link
...
# FIXME Field doesn't link correctly
def solid(
    name=None,
    description=None,
    input_defs=None,
...
def composite_solid(
    ...
    Args:
        ...
        config/config_fn: By specifying a config mapping, you can override
            ...
            configuration for the composite solid, and a configuration mapping function, which is
            called to map the configuration of the composite solid into the configuration that is
